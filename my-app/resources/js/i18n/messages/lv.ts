const lv = {
    ...
    dispatcher: {
        ...
        filters: {
            active_date: 'Datums: :date',
            active_organization: 'Organizācija: :organization',
            active_status: 'Statuss: :status',
            all_organizations: 'Visas organizācijas',
        ...
        routes: {
            add_orders: 'Pievienot pasūtījumus maršrutam',
            add_orders_description:
                'Piešķiriet šim maršrutam vēl pieejamos pasūtījumus.',
            add_selected_orders: 'Pievienot izvēlētos pasūtījumus',
            ...
            remove: 'Noņemt',
            remove_confirm:
                'Noņemt pieturu :number no šī maršruta? Saistītais pasūtījums atgriezīsies statusā PENDING.',
            reset_preview: 'Atiestatīt priekšskatījumu',
            save_order: 'Saglabāt secību',
            stop_order: 'Pietura :number - pasūtījums #:id',
            stops: 'Pieturas',
            stops_description:
                'Pārkārtojiet pieturas lokāli un saglabājiet, kad secība ir pareiza.',
            stops_count: ':count pieturas',
            select_courier: 'Izvēlieties kurjeru',
            select_orders_description:
                'Izvēlieties pasūtījumus, kas jāiekļauj šajā maršrutā.',
            unassigned_empty: 'Pašlaik nav pieejamu nepiešķirtu pasūtījumu.',
    ...
    courier: {
        ...
        stop: {
            arrived: 'Procesā',
            completed: 'Pabeigts',
            confirm_failed: 'Apstiprināt neveiksmi',
            delivered_at: 'Piegādāts',
            failure_placeholder: 'Aprakstiet neveiksmes iemeslu...',
            failed: 'Neizdevās',
            fail_reason: 'Neizdošanās iemesls',
            fail_reason_value: 'Neizdošanās iemesls: :reason',
            google_maps: 'Atvērt Google Maps',
            mark_delivered: 'Atzīmēt kā piegādātu',
            open_file: 'Atvērt failu',
            order_number: 'Pasūtījums #:id',
            proof_uploaded: 'Pierādījums augšupielādēts:',
            reopen: 'Atsākt pieturu',
            ...
            upload_proof_ready_after:
                'Pieejams pēc tam, kad pietura ir pabeigta vai neveiksmīga',
            view_proof: 'Skatīt pierādījumu',
            waze: 'Atvērt Waze',
        },
    },
    landing: {
