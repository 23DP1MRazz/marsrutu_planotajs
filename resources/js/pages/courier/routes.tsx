...
export default function CourierRoutesPage({
    ...
    const completedSortOptions = [
        { value: 'date_desc', label: t('courier.routes.sort.date_desc') },
        { value: 'date_asc', label: t('courier.routes.sort.date_asc') },
        { value: 'stops_desc', label: t('courier.routes.sort.stops_desc') },
        { value: 'stops_asc', label: t('courier.routes.sort.stops_asc') },
    ];
    const upcomingSortOptions = [
        { value: 'date_asc', label: t('courier.routes.sort.date_soonest') },
        { value: 'date_desc', label: t('courier.routes.sort.date_latest') },
        { value: 'stops_desc', label: t('courier.routes.sort.stops_desc') },
        { value: 'stops_asc', label: t('courier.routes.sort.stops_asc') },
    ];
                    ...
                    <BackofficeCard>
                        <div className="grid gap-4 border-b border-[#e5e7eb] px-5 py-4 md:grid-cols-[1fr_180px_auto] md:items-end">
                            <input
                                ...
                                placeholder={t('courier.routes.placeholder')}
